        ...
        <div className="lg:col-span-2 space-y-6">
            <div className="flex items-center justify-between mb-2">
                <h2 className="text-xl font-bold flex items-center gap-2">
                    <span className="material-icons-round text-primary-teacher">feed</span>
                    School Feed
                </h2>
                <button className="text-sm font-semibold text-primary-teacher hover:underline">View All</button>
            </div>

            {/* Event Highlight Post */}
            <div className="bg-white dark:bg-slate-800 rounded-2xl overflow-hidden shadow-sm border border-slate-200 dark:border-slate-700 transition-transform hover:scale-[1.01]">
                <Image
                ...
                <div className="p-6">
                    <div className="flex items-center gap-2 mb-3">
                        <span className="px-3 py-1 bg-primary-teacher/10 text-primary-teacher text-xs font-bold rounded-full uppercase tracking-wider">
                            Event Highlight
                        </span>
                        <span className="text-slate-400 text-xs font-medium">• 2 hours ago</span>
                    </div>
                    ...
                    <div className="mt-6 flex items-center justify-between">
                        ...
                        <button className="flex items-center gap-2 text-slate-500 hover:text-primary-teacher transition-colors">
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
                <div className="flex items-start gap-4">
                    <div className="bg-indigo-100 dark:bg-indigo-900/30 p-3 rounded-xl shrink-0">
                        <span className="material-icons-round text-indigo-600 dark:text-indigo-400">campaign</span>
                    </div>
                    <div>
                        <div className="flex items-center gap-2 mb-1">
                            <span className="text-xs font-bold text-slate-400 uppercase tracking-widest">Announcement</span>
                        ...
                        <button className="text-primary-teacher text-sm font-bold flex items-center gap-1 hover:gap-2 transition-all">
