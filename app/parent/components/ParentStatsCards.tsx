        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 flex items-center gap-4">
                <div className="bg-emerald-100 dark:bg-emerald-900/30 p-4 rounded-xl">
                    <span className="material-icons-round text-emerald-600 dark:text-emerald-400 text-3xl">auto_graph</span>
                </div>
                <div>
                    <p className="text-sm font-medium text-slate-500 dark:text-slate-400">Recent Test Result</p>
                    <div className="flex items-baseline gap-2">
                        <span className="text-3xl font-bold">A+</span>
                        <span className="text-xs font-medium text-slate-500">Mathematics Quiz</span>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-sm font-medium text-slate-500 dark:text-slate-400">Pending Fees</p>
                        <p className="text-3xl font-bold">₹1,250</p>
                    </div>
                </div>
                <button className="bg-primary-teacher hover:bg-indigo-700 text-white px-5 py-2.5 rounded-xl font-semibold transition-all shadow-lg shadow-primary-teacher/20 flex items-center gap-2">
                    Pay Now
